...
routes = [
    ...
    webapp2.Route(r'/<device_id:[-\w]+>/udict/list', handler = handlers.userdictionary.List, name='udict_list'),
    webapp2.Route(r'/<device_id:[-\w]+>/udict/<id:[-\w]+>/update',
                  handler=handlers.userdictionary.Change,
                  name='udict_update'),
    webapp2.Route(r'/<device_id:[-\w]+>/udict/<id:[-\w]+>/get/since/<version:[-\w]+>',
                  handler=handlers.userdictionary.GetDiff,
                  name='udict_since'),
    webapp2.Route(r'/<device_id:[-\w]+>/udict/<id:[-\w]+>/get',
                  handler=handlers.userdictionary.GetDiff,
                  name='udict_get'),
